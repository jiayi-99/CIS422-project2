...
<!--		<link type="image/x-icon" href="/Public/image/ypci.jpg" rel="icon">-->
<!--  		<link type="image/x-icon" href="PUBLIC/image/ypci.jpg" rel="bookmark">-->
		<!--[if lte IE 8]>
        ...
        <link rel="stylesheet" href="/Public/css/glyphicons-halflings-regular.ttf"/>
        <![endif]-->
        ...
        <script src="/Publicjs/respond.min.js"></script>
        <![endif]-->
...
<!--										<?php }else { ?>-->
										<img src="/Public/image/l.jpg" data-reactid=".0.0.0.0.0.1:$0.0.0" style="width: 100%;height: 100%;">
<!--										<?php } ?>-->
									</div>
									
									<form action="<?php echo U('ajax_login');?>" method="post" class="form-horizontal col-md-6" data-reactid=".0.0.0.0.0.1:$0.1">
										...
										<div style="margin:0px 60px;" data-reactid=".0.0.0.0.0.1:$0.1.2">
											<div class="form-group" data-reactid=".0.0.0.0.0.1:$0.1.2.0">
												<div class="input-group" data-reactid=".0.0.0.0.0.1:$0.1.2.0.1:$input-group">
													...
													<input type="text" placeholder="please enter user name" class="form-control" name="username">
												</div>
											</div>
...
<!--                                                <input id="img_code" name="img_code" type="text" class="form-control" placeholder="验证码" style="display: inline-block; width: 32%; float: left;" required="">-->
<!--                                                <img id="imgcode" onclick="$('#imgcode').attr('src','/admin.php/Common/img_code');" src="/admin.php/Common/img_code" style="height: 34px; float: right;">-->
<!--                                                <br>-->
<!--                                                <div id="message" style="clear: both; text-align: center; height: 32px; line-height: 32px;"></div>-->
<!--                                            </div>-->

											<div data-reactid=".0.0.0.0.0.1:$0.1.2.2" class="form-group">
												<button  type="submit" class="btn-block btn" data-reactid=".0.0.0.0.0.1:$0.1.2.2.0">log in</button>
<!--                                                <div  type="submit" class="btn-block btn" data-reactid=".0.0.0.0.0.1:$0.1.2.2.0" onclick="zhuce()">注册</div>-->
												<br/>

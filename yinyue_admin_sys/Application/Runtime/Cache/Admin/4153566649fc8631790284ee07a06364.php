    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-12">
            ...
            <h2>
                ...
                <a href="/admin.php/Singer/Singer_operation" class="btn btn-primary pull-right">Add to</a>
                        ...
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂无数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin.php/Singer/Singer_operation?id=<?php echo ($vo["id"]); ?>" class="btn btn-xs btn-success"> edit</a>

                                        <a href="/admin.php/Singer/del_Singer?id=<?php echo ($vo["id"]); ?>" class="btn btn-xs btn-success"> delete</a>

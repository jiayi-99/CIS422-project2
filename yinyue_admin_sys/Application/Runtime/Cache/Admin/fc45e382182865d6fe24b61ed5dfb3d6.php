...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2>
			角色管理
			<a href="/admin.php/System/auth_group_operation" class="btn btn-primary pull-right">添加角色</a>
		</h2>
		<ol class="breadcrumb">
				...
				<thead>
		 		...
		 		<tbody>
		 			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂无数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<a href="/admin.php/System/auth_group_operation?id=<?php echo ($vo["id"]); ?>" class="btn btn-xs btn-primary">编辑</a>
						</td>

    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-12">
            ...
            <h2>
                ...
                <a href="/admin.php/System/auth_rule_operation" class="btn btn-primary pull-right">添加规则</a>
                    ...
                    <div class="ibox-content" style="display: block;">
                        ...
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂无数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td style="color: #008000;">正常</td>

                                    <td><?php echo ($vo['createtime']); ?></td>

                                    <td>

                                        <a href="/admin.php/System/auth_rule_operation?id=<?php echo ($vo["id"]); ?>" class="btn btn-xs btn-primary">编辑</a>

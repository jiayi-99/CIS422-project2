...
<div id="message_inform" style="position: fixed; bottom: -160px; right: 16px; z-index: 999999999; width: 240px; height: auto; text-align: center; background-color: #F6F6F6; border: 1px solid #666666; border-radius: 3px; transition: width 1s linear 2s; -moz-transition: all 1s; -webkit-transition: all 1s; -o-transition: all 1s;">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-12">
            ...
            <?php if($form['id'] != null): ?><h2>Edit the singer</h2>

                <?php else: ?>

                <h2>Add singer</h2><?php endif; ?>
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    ...
                    <?php if($form['id'] != null): ?><strong>Edit the singer</strong>

                        <?php else: ?>

                        <strong>Add singer</strong><?php endif; ?>
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <?php if($form['id'] != null): ?><h5>Edit the singer</h5>

                            <?php else: ?>

                            <h5>Add singer</h5><?php endif; ?>
                    ...
                    <div class="ibox-content layui-form" style="display: block;">
                        ...
                        <?php if($form['id'] != null): ?><form autocomplete="off" action="/admin.php/Singer/edit_Singer" method="post" class="form-horizontal">
                                ...
                                <form autocomplete="off" action="/admin.php/Singer/add_Singer" method="post" class="form-horizontal"><?php endif; ?>

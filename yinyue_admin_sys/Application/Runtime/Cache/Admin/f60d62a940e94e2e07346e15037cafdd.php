...
<div id="message_inform" style="position: fixed; bottom: -160px; right: 16px; z-index: 999999999; width: 240px; height: auto; text-align: center; background-color: #F6F6F6; border: 1px solid #666666; border-radius: 3px; transition: width 1s linear 2s; -moz-transition: all 1s; -webkit-transition: all 1s; -o-transition: all 1s;">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-12">
            ...
            <h2>
                ...
                <a href="/admin.php/Song/Song_operation" class="btn btn-primary pull-right">Add to</a>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <form action="" method="post" class="col-lg-12 form-horizontal" style="line-height: 48px;">
            ...
            <input id="name" name="name" value="<?php echo ($name); ?>" class="form-control layer-date" placeholder="name" />
                        ...
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "No data" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin.php/Song/Song_operation?id=<?php echo ($vo["id"]); ?>" class="btn btn-xs btn-success"> edit</a>

                                        <a href="/admin.php/Song/del_Song?id=<?php echo ($vo["id"]); ?>" class="btn btn-xs btn-success"> delete</a>
